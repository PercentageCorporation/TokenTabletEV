    ...
    <div class="grid-body" :style="{height: tableBodyHeight + 'px'}">
      <div class="table-header-wrapper">
        <table class="table-header">
          <tr>
            <th v-for="(column,index) in columns" :key="index"  :width="column.width ? column.width : '100'"> {{column.label}}</th>
          </tr>
        </table>
      </div>
      <div class="table-body-wrapper">
        <table class="table-body">
          <tr v-for="(row,index) in rows" :key="index">
            <td v-for="(column,index) in columns" :key="index" :width="column.width ? column.width : '100'"> {{val(row, column.field)}}</td>
          </tr>
        </table>
      </div>
    </div>
